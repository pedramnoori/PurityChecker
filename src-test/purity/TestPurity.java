...
//    }
    ...
    public void extractMethodTest_53() throws RefactoringMinerTimedOutException, IOException {
        ...
        UMLModelDiff umlModelDiff = miner.detectModelDiff(
                new File("C:\\Users\\Pedram\\Desktop\\TestCases\\TestCases\\TestCases\\32\\v1"),
                new File("C:\\Users\\Pedram\\Desktop\\TestCases\\TestCases\\TestCases\\32\\v2"));
//        List<Refactoring> refactorings = modelDiff.getRefactorings();
        Map<Refactoring, PurityCheckResult> pcr = PurityChecker.isPure(umlModelDiff);
        System.out.println("HERE");
    }
    ...
    public void extractMethodTest_54() throws RefactoringMinerTimedOutException, IOException {
        ...
        GitHistoryRefactoringMiner miner = new GitHistoryRefactoringMinerImpl();
        miner.detectModelDiff("https://github.com/droolsjbpm/drools.git",
                "1bf2875e9d73e2d1cd3b58200d5300485f890ff5", new RefactoringHandler() {
                    @Override
                    public void processModelDiff(String commitId, UMLModelDiff umlModelDiff) throws RefactoringMinerTimedOutException {
                        Map<Refactoring, PurityCheckResult> pcr = PurityChecker.isPure(umlModelDiff);
                        System.out.println("HERE");
...
//  The test commit TODO second runTests Extract method is pure and I reported it as impure so far
        GitHistoryRefactoringMiner miner = new GitHistoryRefactoringMinerImpl();
        miner.detectModelDiff("https://github.com/linkedin/rest.li.git",
                "ec5ea36faa3dd74585bb339beabdba6149ed63be", new RefactoringHandler() {
                    @Override
                    public void processModelDiff(String commitId, UMLModelDiff umlModelDiff) throws RefactoringMinerTimedOutException {
                        Map<Refactoring, PurityCheckResult> pcr = PurityChecker.isPure(umlModelDiff);
                        System.out.println("HERE");
...
//    }
    ...
    public void extractMethodTest_58() throws RefactoringMinerTimedOutException, IOException {
        ...
        GitHistoryRefactoringMiner miner = new GitHistoryRefactoringMinerImpl();
        miner.detectModelDiff("https://github.com/facebook/buck.git",
                "f26d234e8d3458f34454583c22e3bd5f4b2a5da8", new RefactoringHandler() {
                    @Override
                    public void processModelDiff(String commitId, UMLModelDiff umlModelDiff) throws RefactoringMinerTimedOutException {
                        Map<Refactoring, PurityCheckResult> pcr = PurityChecker.isPure(umlModelDiff);
                        System.out.println("HERE");
